...
public class CommonParserRulesBaseVisitor<T> extends AbstractParseTreeVisitor<T>
		implements CommonParserRulesVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 * <p>
	 ...
	 */
	@Override
	public T visitExpr(CommonParserRulesParser.ExprContext ctx) {
		return visitChildren(ctx);
	}
