...
public interface CommonParserRulesListener extends ParseTreeListener {
	 ...
	 * {@link CommonParserRulesParser#nonPrimitiveType}.
	 * 
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by
	 * {@link CommonParserRulesParser#paramInputList}.
	 * 
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link CommonParserRulesParser#expr}.
	 * 
	 * @param ctx the parse tree
	 */
	void enterExpr(CommonParserRulesParser.ExprContext ctx);

	/**
	 * Exit a parse tree produced by {@link CommonParserRulesParser#expr}.
	 * 
	 * @param ctx the parse tree
	 */
	void exitExpr(CommonParserRulesParser.ExprContext ctx);
