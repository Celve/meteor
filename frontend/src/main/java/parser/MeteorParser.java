...
public class MeteorParser extends Parser {
	...
	public static final int
		...
		RULE_returnType = 13, RULE_funcSuite = 14, RULE_funcDef = 15, RULE_funcDecl = 16, 
		...
		RULE_assignUnit = 24, RULE_varDecl = 25, RULE_jump = 26, RULE_extendedBlock = 27, 
		RULE_cond = 28, RULE_while = 29, RULE_forInitUnit = 30, RULE_forCondUnit = 31, 
		RULE_forStepUnit = 32, RULE_for = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "suite", "block", "field", "decl", "def", "varType", "primitiveType", 
			"voidType", "nonPrimitiveType", "classSuite", "classDef", "classCtor", 
			"returnType", "funcSuite", "funcDef", "funcDecl", "paramDefList", "paramInputList", 
			"lambdaDef", "basicExpr", "stmt", "prefixOps", "expr", "assignUnit", 
			"varDecl", "jump", "extendedBlock", "cond", "while", "forInitUnit", "forCondUnit", 
			"forStepUnit", "for"
		};
	}
	...
	public final FuncSuiteContext funcSuite() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 612346549837627448L) != 0) {
				{
				setState(146);
				_errHandler.sync(this);
	...
	public static class FuncDeclContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MeteorListener ) ((MeteorListener)listener).enterFuncDecl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MeteorListener ) ((MeteorListener)listener).exitFuncDecl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MeteorVisitor ) return ((MeteorVisitor<? extends T>)visitor).visitFuncDecl(this);
			else return visitor.visitChildren(this);
		}
	}
